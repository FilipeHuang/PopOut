...
- ``arena.py``, a tournament/simulation mode for running automated matches without the interface
...
Data generation: ``generate_dataset.py``, generate the dataset based on mcts gameplay
